;# ====================================================================
;#
;# gifcat.pl: GIFÇÑÇ{Ç~Çç³sµ²ÇåÇ~ÇÒÇåÇæ Ver1.50
;#
;# Copyright (c) 1997,1998 s-hasei@mtg.biglobe.ne.jp
;#
;# µÛ§@ÅvÇV©ñ±óÆýÇeÇBÇzÆò¡B¦Û¥ÑÇR¨Ï¥Î¡E§ï³y¡E¦A°t¥¬¥i¯àÇNÇ@¡C
;# §ï³yª©Çy¦A°t¥¬Ç@Çr»ÚÇV¡B¥²ÇAÇÑÇ{Ç~Çç¦WÇyÅÜ§óÆýÇM¡BÇ¦ÇæÇ´ÇÆÇçÇy²K¥IÆýÇM
;# °t¥¬ÆýÇMÆõÇGÆûÆê¡C
;#
;# °ò¥»ªºÇQ¨ÏÆê¤è
;#    require "gifcat.pl";
;#    open(OUT, "> out.gif");
;#    binmode(OUT);    # MS-DOS Çk Windows ÇU³õ¦XÇR¥²­nÇNÇ@¡C
;#    print OUT &gifcat'gifcat("xx.gif", "yy.gif", "zz.gif");
;#    close(OUT);
;#
;# ÇÃÇÌÇ¿Ç¬¥Î(GIFÇU¸ÑªR¥X¤O)
;#    require "gifcat.pl";
;#    &gifcat'gifprint("xx.gif", "yy.gif", "zz.gif");
;#
;# ¨î­­¨Æ¶µ
;#    Ç|ÇÇÇÝGIFÇV³sµ²ÇNÆóÇeÇBÇz¡C
;#    ¤jÆóÆûÇU²§ÇQÇrGIFÇÑÇ{Ç~ÇçÇV³sµ²ÇNÆóÇeÇBÇz¡C
;#
;# ³Ì·sª©¤J¤â¥ý
...
;# §ó·s¼i¾ú:
;#    1997.05.03 ªìª©¡C
;#    1997.05.10 ÇµÇÖÇçÇÛÇµ­×¥¿¡C
;#    1997.05.29 Ç±Ç~Ç¶ÇU²§ÇQÇrÇ§ÇåÆãÇÂÆãÇÒÇçÇR¹ïÀ³¡C
;#    1997.07.07 Ç¤ÇåÆãµo¥Í®ÉÇRexit()ÆýÇQÆêÇoÆìÇR­×¥¿¡C
;#    1998.05.05 TrailerÇy«ùÇFÇQÆêGIFÇÑÇ{Ç~ÇçÇy³sµ²ÇNÆóÇQÆêÇÌÇ¬Çy­×¥¿¡C
;#    1998.05.05 ¾î´TÆò256Çy¶WÆîÇrGIFÇU¥X¤OÆòÇNÆóÇQÆêÇÌÇ¬Çy­×¥¿¡C
;#    1998.05.05 gifprint()ÇN³sµ²µ²ªGÇy¥X¤OÆýÇQÆêÇoÆìÇR­×¥¿¡C
;#    1998.05.10 ³sµ²ÇNÆóÇQÆêGIFµe¹³ÆòÆèÇrÇOÆêÆìÇÌÇ¬Çy­×¥¿¡C
;#    1998.08.20 Ver1.50 ÅÜ¼ÆÇUªì´Á¤ÆÇy¦æÆìÇoÆìÇR­×¥¿¡C
;#    1998.08.20 Ver1.50 ³z¹LGIFÇR¹ïÀ³¡C
;#
;# ====================================================================
